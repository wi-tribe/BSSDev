  ...
  <?	$index=1;
		...
		{ ?>
          <tr>
            ...
            <a href="#" class= "options" onclick="javascript:AjaxPopUpWindow( 'Pages/Commissioning/EditCommission.php','commission_id=<?=$arr['commission_id']?>','top=100, left=100,height=400, width=600, status=no, menubar=no, resizable=no, scrollbars=no, toolbar=no,location=no, directories=no' );" >Edit</a></td>
            <? } ?>
          </tr>
  <? } ?>
