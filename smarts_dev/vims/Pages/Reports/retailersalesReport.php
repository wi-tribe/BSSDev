<?PHP
	...
	$ch_obj = new Channel();
        ...
        $channel_type_id 	= $retailer['channel_type_id'];
	$channel_type_name	= $retailer['channel_type_name'];
	...
	if($return=='Shop')
	{
		$users = $ch_obj->getUserByChannel($channel_id);
	}else{
            ...
            <form name="collectionReport" id="collectionReport" method="post" action="FormProcessor/Reports/salesReport.php">
                 <input type="hidden" name ="permission" id="permission" value="<?=$return?>">
								...
								<tr>
									...
									<td>
										...
										{	?><?=$channel_type_name?>
                                                                                        ...
                                                                                        <script> processForm( 'collectionReport','FormProcessor/Reports/getRegionalChannels.php','channeldiv' )</script>
									<?	} else
										{	?>
											<?=$channel_type_name?>
											<input type="hidden" name ="channel_type" id="channel_type" value="<?=$channel_type_id?>">
					...
					<tr>
						...
						<input name="FormAction" type='button' id="display" value='Display Report' onclick="javascript:processForm( 'collectionReport','FormProcessor/Reports/retailersalesReport.php','Report' );">
						</td>
                    </tr>
