...
<table width="70%" border="0" cellspacing="1" cellpadding="2">
			<tr>
              ...
              <tr>
              <td><input type="checkbox" name="Check_All" value="Check_All" onClick="CheckAll(document.ReturnInventory.voucher_serial)"></td>
...
{
 var total=0;
var max = ReturnInventory.voucher_serial.length;
for(var idx = 0; idx < max; idx++)
{
if(eval("document.ReturnInventory.voucher_serial[" + idx + "].checked") == true)
{
total += 1;
}
}
...
{
var checkon = 0;
if(document.ReturnInventory.Check_All.checked==false)
  {
  ...
  if(document.ReturnInventory.Check_All.checked==true)
  {
    for (i = 0; i < chk.length; i++)
    {
        chk[i].checked = true ;
