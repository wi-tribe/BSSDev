		...
		<tr valign="top" class="textbox" >
			<td align="center">
              <!-----------------------------THIS PAGE------------------------------------->
				...
				<tr>
				  <td align='right'><input name="FormAction" type='button' value='Reset' onclick="javascript:processForm( 'changePassword','FormProcessor/User/changePassword.php','MsgDiv' );"></td>
				</tr>
			  </table>
                        </form>
              <!--------------------------------THE END------------------------------------->
