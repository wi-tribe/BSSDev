<?PHP
	...
	$return = $GLOBALS['_GACL']->getaccessLevel($_SESSION['username'],'SalesReturn');
  ...
  function unselect()
    {
        ...
        document.getElementById('user').selectedIndex = 0;
            ...
            <form name="salesReturnReq" id="salesReturnReq" method="post" action="FormProcessor/SalesReturnReq_Dunning.php">
				 ...
				 <table width="100%">
					<tr>
						<td colspan="2" align="center" style="font-size:16px"><strong>Sales Return Requests </strong></td>
					</tr>
					<tr>
						<td>
							<table width="100%">
								<tr>
									...
									<td>
										<?	if($return == 'NWD')
										{	?>
											<select name='region' id='region' class="selectbox" onchange="javascript:processForm( 'salesReturnReq','FormProcessor/Reports/getRegionalShops.php','channeldiv' ); unselect(); ">
					...
					<tr>
						...
						<input name="FormAction" type="button" id="display" value='Process' onclick="javascript:processForm( 'salesReturnReq','FormProcessor/SalesReturnReq_Dunning.php','Report' );">
						</td>
                    </tr>
