<?php
	...
	$sales_rep = $sales_obj->getCurrentCSR();
        ...
        if(!$permission->checkPermission($sales_rep['USERID'], 'CustomerPayment'))
        {
	...
	var post_func = function()
				{
					...
					$.post("../FormProcessor/ajax_customer_payment_1.php",{searchOption:searchOption,SearchTxt:SearchTxt,CacheView:CacheView},effect);
				}
