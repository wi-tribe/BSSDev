	...
	var post_func = function()
				{
					...
					$.post("../FormProcessor/ajax_verify_cnic_1.php",{CNIC: cnic_var, MAC: mac_address},effect);
				}
        ...
        <!-- ================================= Start Content TD =============================== -->
                         <form name="search_form" id="search_form" action="" method="post"  >
                          ...
                          <tr>
                            ...
                            <td class="textboxBur"><input type="text" name="txt_mac" id="txt_mac"  /></td>
                            <td align="center"></td>
                          </tr>
                           <tr>
                            <td class="textboxBur">CNIC: </td>
                            <td class="textboxBur"><input type="text" name="txt_cnic" id="txt_cnic"  /></td>
