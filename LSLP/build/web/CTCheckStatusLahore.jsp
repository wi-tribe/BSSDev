...
<input type=hidden name=cvgchkstatue value="<%=sPointCoverage%>">
                                                         ...
                                                         <tr><td align="right"> <input type="button" value="Save&nbsp;as&nbsp;Prospect" name="ConvertToProspect" onclick="javascript:formSubmit1('./GetReason.do?leadId=<%=request.getParameter("leadId")%>')"/></td>
