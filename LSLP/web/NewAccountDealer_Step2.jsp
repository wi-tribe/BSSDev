...
r_LeadId = (( session.getAttribute("newAcct_Leadid") == null) ? "" : (String)session.getAttribute("newAcct_Leadid"));
...
else if (referrer.equals(DSTEP3)) {
...
//depending on the bill type
    ...
    System.out.println("Email iz:" + inv_email);
    System.out.println("zip code is:"+inv_zip);
...
//iterate through the input for the phones
    ...
    System.out.println("Service Desc: "+SERVICE_DESCR);
...
//out.print ("<pre>" + svsfl.toString () + "<pre><hR><br>");
   ...
   if(access1 != null){
    ...
    //String st1 = access1[0]+"/"+access1[1];
...
// -- End Device association.
     // SparseArray ssArray1 = null;
      // ssArray1 = newAcctFl.get(FldProfiles.getInst());
    // if(1==1)  return;
...
//extract error
        ...
        sucMsg = sucMsg + "Successfully created Account# <b>[#BRMACTNO]</b><br><br>";
...
<form name=frmCreate2 method="post" action="./DealerAccountCreationStep2Action.do" onsubmit="return newAcctNext(this) ">
<table width="95%" border="0" cellspacing="0" cellpadding="0"  class="Act-listing">

<% if(serviceDescriptions != null ) {    %>
<tr><th colspan="3"><label for="SectionHead">Service Login Details</label></th></tr>
...
<% } else {%>
<tr><th colspan="3"><label for="SectionHead">Service  Details</label></th></tr>
<tr  class='info-listing'>
...
<tr><th colspan="3"><label for="SectionHead">Device Details</label></th></tr>
<tr  class='info-listing'>
...
<tr>
    ...
    <td >
        <input type="text" class="txtxx" name="<%=EMAIL%>" id="inv_email" value="<%=((inv_email != null ) ? inv_email : "")%>" /><p class="validationmsg"></p>
    </td>
    <% } else { %>
    <td colspan=2>&nbsp;</td>
    <% } %>
...
<tr>
    ...
    <td ><input type="text" class="txtxx" name="txtSubzone" id="txtSubzone" value="<%=sSubZone%>" /><p class="validationmsg"></p></td>
    ...
    <input type=hidden NAME="bill_address1" value="<%=inv_address%>" />
...
<td><label>Zip<span class="mandatory">&nbsp;*</span></label></td><td><INPUT TYPE="TEXT" name="zip" id="bill_zip" class="txtxx" SIZE="9" value="<%= inv_zip %>" /><P class=validationmsg></p></td></tr>
...
<tr  class="bill-listing"><th>&nbsp;</th><th>
        ...
        <INPUT Type="hidden" Name="referrer" Value="<%=DSTEP3%>">
