...
<div id="inner-content">
    <form action="./ViewLead.do" method="Post">
    ...
    <div class="scrollable">
     <table width="679" border="0" cellspacing="0" cellpadding="0" class="bill-listing">	
        ...
        <tr>
            ...
            <!--<th valign="middle" width="192" align="left">House/Plot</td>
        ...
        <tr><td valign="middle" width="131"><a href="./ViewLead.do?leadId=<bean:write name='objLead' property='leadId' />"><u><bean:write name="objLead" property="leadId" /></u></a></td>
