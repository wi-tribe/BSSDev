  ...
  <div id="inner-content">
   <div class="shadow-box">
       <div class="shadow-box-inner">
        <form  action="./ModifySalesPersonnel.do" method="Post" onsubmit="javascript: return ValidateSalesForm(this,'profile');">
                    <table width="642" border="0" cellspacing="0" cellpadding="0" class="info-listing">
                        <bean:define id="objSales"  name="objSale" type="com.witribe.sales.vo.SalesPersonnelVO" scope="request"/>
                           ...
                           <td width="126"><label>UserId</label><span class="mandatory">*</span></td>
                       <td width="200"><input type="text"  class=txtxx name="userId" value="${objSales.userId}" maxlength="15" readonly /><p class="validationmsg"></p></td></tr>
                       <tr><td width="134"><label>Password</label><span class="mandatory">*</span></td>
                       <td width="180"><input type="password"  class=txtxx name="password" value="" maxlength="30"/><p class="validationmsg"></p></td>
                       <td width="134"><label>Confirm Password</label><span class="mandatory">*</span></td>
