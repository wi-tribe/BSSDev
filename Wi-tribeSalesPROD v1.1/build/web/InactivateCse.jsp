...
<form action="" method="Post">
    <input type="hidden" name="page" />
     ...
     <logic:notEmpty name="objSalesList" >
        <p>Choose any of the following Salespersons to change status</p>
     </logic:notEmpty>
                     <div id="inner-content">
                         ...
                         <div class="scrollable">
                             <table width="679" border="1" cellspacing="0" cellpadding="0" class="bill-listing">
                                 ...
                                 <tr>
                                     ...
                                     <th valign="middle" width="100" align="left">Salesperson Status</th>
                                 </tr>
                                 ...
                                 <logic:iterate id="objSale" name="objSalesList" type="com.witribe.sales.vo.SalesPersonnelVO" scope="request">
                                     ...
                                     <c:choose><c:when test="${objSale.city != null}">
                                          ...
                                          <td valign="middle" width="100">
                                     <c:choose><c:when test="${objSale.salespersonstatus != null}">
                                                     ${objSale.salespersonstatus}
                                                     </c:when>
                                                     <c:otherwise>
                                                         --
                                                     </c:otherwise>
                         ...
                         <tr> </tr>
                       <tr> <td><label><b>CSE Status</b></label></td>    
                                <td><select name="cseStatus">

                                    <c:choose>
                                        <c:when test="${cseStatus == 'Active'}">
                                    ...
                                    <c:choose>
                                        <c:when test="${cseStatus == 'Inactive'}">
         ...
         <tr><td colspan="1"><input type="button" name="Submit" value="Submit" onclick="return changeCseAccountStatus('./SubmitCSEStatus.do',this);"/></td>
                        </tr>
