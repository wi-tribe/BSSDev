...
<body onload="javascript:bodyload();">
    ...
    <table width="642" border="0" cellspacing="0" cellpadding="0" class="info-listing">
        <tr><td><label>Channel</label></td>
            ...
            <c:if test="${CHANNEL_TYPE==WitribeConstants.CSE_CSO}">
            <td><input type= text name=channeltype class="txtxx" value="CSO" readonly></td>
            </c:if>  
    ...
    <!--Commented by Swapna for Lead Source change on Sep 2nd
