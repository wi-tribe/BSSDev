<%@page contentType="text/html" import="com.witribe.vo.LeadVO,com.witribe.sales.vo.ShopsVO"%>
<%@taglib uri="/WEB-INF/struts-logic.tld" prefix="logic"%> 
<%@taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"%> 
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%> 
<script language="javascript" type="text/javascript" src="js/witribescript.js"></script>
 <p>Choose any of the following Shop to modify/delete</p>
   <form action="./ViewShops.do" method="Post">
        ...
        <div class="scrollable">                       
                   ...
                   <table border="0" align="right" width="150">
                         ...
                         <table>
                      <tr><td colspan="1"><input type="button" name="Modify" value="Modify" onclick="javascript: return CommonModify('./ViewShops.do');"/></td>
                      <td colspan="1"><input type="button" name="Delete" value="Delete" onclick="javascript: return CommonDelete('./DeleteShop.do');"/></td></tr>
                      </logic:notEmpty >
