 ...
 * @author SC43278
 */
public class InactivateCseAction extends BaseAction{
    
    /** Creates a new instance of SalesDataDeleteAction */
    public InactivateCseAction() {
    }
    public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest req,HttpServletResponse res) {
        ...
        try{
            ...
            if( inactiveSalesPersonnel(sform,req)) {
            ...
            if(e.getErrorCode() == WitribeConstants.ORA_REF_ERR) {
               req.setAttribute(WitribeConstants.HEADING,WitribeConstants.FAILED_INACTIVATE_CSE); 
               req.setAttribute(WitribeConstants.ERR_VAR,WitribeConstants.MSG_CSE); 
               return mapping.findForward("failure") ;
           }
    ...
    boolean inactiveSalesPersonnel(SalesPersonnelForm sform,HttpServletRequest req)throws SQLException,Exception{
